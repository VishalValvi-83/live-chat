...
//         // Card parallax
//         gsap.fromTo(
//           item.querySelector(".parallax-card"),
//           { y: 80 * direction },
//           {
//             y: -80 * direction,
//             ease: "none",
...
//         // Text parallax
//         gsap.fromTo(
//           item.querySelector(".parallax-text"),
//           { y: -40 * direction },
//           {
//             y: 40 * direction,
//             ease: "none",
...
//         // Icon micro depth
//         gsap.fromTo(
//           item.querySelector(".parallax-icon"),
//           { y: 20 },
//           {
//             y: -20,
//             ease: "none",
...
//               style={{
//                 background: isDark
//                   ? "linear-gradient(to bottom, #030712, #0a1628, #030712)"
...
//             <div
//               ref={bgOrbRightRef}
//               className="absolute top-1/3 right-[-200px] w-[600px] h-[600px] rounded-full blur-[160px]"
//               style={{ backgroundColor: `${accentColor}22` }}
//             />

//             <div
//               ref={bgOrbLeftRef}
//               className="absolute bottom-1/4 left-[-150px] w-[500px] h-[500px] rounded-full blur-[140px]"
//               style={{
...
//             <p className={`text-xl max-w-2xl mx-auto ${textMuted2}`}>
//               Video calls, voice calls, voice messages — communicate the way that
//               works best for you
//             </p>
//           </motion.div>
...
//                   >
//                     <div
//                       className={`absolute inset-0 bg-gradient-to-br ${feature.color} opacity-20 rounded-3xl blur-3xl group-hover:opacity-30 transition-opacity`}
//                     />

//                     <div
//                       className={`relative bg-gradient-to-br ${cardBg} backdrop-blur-xl rounded-3xl p-8 border ${borderColor} overflow-hidden`}
//                     >
//                       <div className="absolute top-4 right-4 flex gap-2">
//                         <div className="w-3 h-3 rounded-full bg-red-400/50" />
//                         <div className="w-3 h-3 rounded-full bg-yellow-400/50" />
...
//                         >
//                           <feature.icon
//                             className={`h-24 w-24 bg-gradient-to-br ${feature.color} bg-clip-text`}
...
//                   {/* Text */}
//                   <div
//                     className={`flex-1 space-y-6 parallax-text ${isEven ? "lg:pl-16" : "lg:pr-16"
//                       }`}
//                   >
...
//                     <div>
//                       <div
//                         className={`inline-block px-3 py-1 rounded-lg bg-gradient-to-r ${feature.color} bg-opacity-20 text-xs font-medium mb-3 ${textMuted}`}
//                       >
//                         {feature.stats}
//                       </div>
//                       <h3
//                         className={`text-3xl lg:text-4xl font-bold mb-4 ${textColor}`}
//                         style={{ fontFamily: "'Space Grotesk', sans-serif" }}
//                       >
//                         {feature.title}
//                       </h3>
...
export default function HomePage() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen cursor-none overflow-x-hidden" style={{ backgroundColor: bgColor }}>
      ...
      <motion.div
        className="fixed w-8 h-8 rounded-full border-2 pointer-events-none z-[9999] mix-blend-difference"
        style={{ left: cursorXSpring, top: cursorYSpring, x: "-50%", y: "-50%", borderColor: accentColor }}
      />
      <motion.div
        className="fixed w-2 h-2 rounded-full pointer-events-none z-[9999] mix-blend-difference"
        style={{ left: cursorX, top: cursorY, x: "-50%", y: "-50%", backgroundColor: accentColor }}
      />
